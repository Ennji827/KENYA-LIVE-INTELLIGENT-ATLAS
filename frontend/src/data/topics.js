...
export const TOPICS = [
  ...
  },
  {
    ...
    unit: "ha",
    metricLabel: "Planted forest area",
    aggregation: "sum",
    decimals: 0,
    range: [500, 90000],
    skew: 1.8,
    ...
    higherIsBetter: true,
    description:
      "Established plantation and reforestation cover — a measure of restoration and commercial forestry.",
    liveHint: "Connect the forestry service plantation registry.",
  },
  {
    id: "natural_forest",
    ...
    category: "Environment",
    unit: "% cover",
    metricLabel: "Natural forest cover",
    aggregation: "avg",
    decimals: 1,
    range: [0.5, 45],
    skew: 1.4,
    ...
    higherIsBetter: true,
    description:
      "Indigenous and closed-canopy forest cover, a key indicator of biodiversity and carbon stock.",
    liveHint: "Connect a canopy / land-cover remote-sensing source.",
  },
  {
    id: "water_bodies",
    label: "Water Bodies",
